 ...
 * @author Joel
 */
public class DatosCooperativa extends javax.swing.JDialog {

    /**
     * Creates new form DatosCooperativa
     */
    public DatosCooperativa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DatosCooperativa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DatosCooperativa dialog = new DatosCooperativa(new javax.swing.JFrame(), true);
