...
public class GUIProveedor extends javax.swing.JDialog {
    ...
    public GUIProveedor(java.awt.Frame parent, boolean modal,Object entidad ) {
        super(parent, modal);
        initComponents();
        if (entidad instanceof Proveedor) {
            // si es un proveedor que
            System.out.print("proveedor");
        } else {
              System.out.print("asociado");
 // es un cliente 
        }
        this.setTitle(Constantes.NAME_NUEVO_PROVEEDOR);
        this.setLocationRelativeTo(null);
    ...
    /**
     * This method is called from withine the constructor to initialize the form.
