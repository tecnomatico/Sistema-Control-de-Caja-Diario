 ...
 * @author Joel
 */
public class GestorAsociado extends javax.swing.JDialog {

     int numeroSeleccion;
     
    /**
     * Creates new form GestorAsociado
     */
    public GestorAsociado(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
       Asociados nuevoAsociado = new Asociados(null, true);
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestorAsociado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GestorAsociado dialog = new GestorAsociado(new javax.swing.JFrame(), true);
