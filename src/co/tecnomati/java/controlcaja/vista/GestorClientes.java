 ...
 * @author Joel
 */
public class GestorClientes extends javax.swing.JDialog {

    /**
     * Creates new form GestorClientes
     */
    public GestorClientes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GestorClientes dialog = new GestorClientes(new javax.swing.JFrame(), true);
