 ...
 * @author Joel
 */
public class GestorProveedores extends javax.swing.JDialog {

    /**
     * Creates new form GestorProveedores
     */
    public GestorProveedores(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void btnCancelar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelar1ActionPerformed
        Proveedor nuevoProveedor = new Proveedor(null, true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GestorProveedores dialog = new GestorProveedores(new javax.swing.JFrame(), true);
