 ...
 * @author Joel
 */
public class GestordeConcepto extends javax.swing.JDialog {

    /**
     * Creates new form GestordeConcepto
     */
    public GestordeConcepto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void btnNuevoConceptoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoConceptoActionPerformed
           Conceptos nuevoConcepto = new Conceptos(null, true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestordeConcepto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GestordeConcepto dialog = new GestordeConcepto(new javax.swing.JFrame(), true);
